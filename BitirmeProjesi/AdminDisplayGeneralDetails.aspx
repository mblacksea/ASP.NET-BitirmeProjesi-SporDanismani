<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel.Master" AutoEventWireup="true" CodeBehind="AdminDisplayGeneralDetails.aspx.cs" Inherits="BitirmeProjesi.AdminDisplayGeneralDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div runat="server" class="header">
            <h4 runat="server" id="detailProgramDesc" class="title"><asp:Label ID="Label100" runat="server" Text="General Details -> "></asp:Label> </h4>
             ...
             <div class="col-lg-5 col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select count(*) as Count,replace(convert(NVARCHAR, up.BuyDate, 104), ' ', '/') as buydate,cast(up.BuyDate as date) as buydate2 from UserProgram up where up.Program_ID in (select p.Program_ID from Program p ) group by up.BuyDate">
                    ...
                    <div class="col-md-3">
                        <asp:Chart ID="Chart2" DataSourceID="SqlDataSource2" runat="server">
                         ...
                         <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select sum(pr.ProgramPrice*cnt) as totalPrice,replace(convert(NVARCHAR, x.BuyDate, 104), ' ', '/') as buydate ,cast(x.BuyDate as date) as buydate2 from Program pr,(select COUNT(*) as cnt,up.BuyDate,up.Program_ID from UserProgram up where up.Program_ID in(select p.Program_ID from Program p ) group by up.BuyDate,up.Program_ID) x where pr.Program_ID=x.Program_ID group by x.BuyDate">
