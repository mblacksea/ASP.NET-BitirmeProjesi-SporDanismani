<%@ Page Title="" Language="C#" MasterPageFile="~/TrainerPanel.Master" AutoEventWireup="true" CodeBehind="TrainerGraphics.aspx.cs" Inherits="BitirmeProjesi.TrainerGraphics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">My Programs -> Graphics</h3>
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                         <asp:Button ID ="search" Text="Search"  OnClick="search_Click" CssClass="btn btn-primary" CausesValidation="false" runat="server" />
...
<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
           <h3> <asp:Label ID="LabelShowDetails" runat="server" Text="" ></asp:Label>   </h3>     
    ...
    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"  CssClass= "table table-striped table-bordered table-condensed" AutoGenerateColumns="False" DataKeyNames="Program_ID" DataSourceID="SqlDataSource1" AllowPaging="True">
        <Columns>
